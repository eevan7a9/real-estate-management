...
export const propertiesRoutes = function (fastify, opts, done) {
  ...
  fastify.get("/map", getPropertiesMapOpts(getPropertiesMap));
  fastify.get("/me", getMyPropertiesOpts(fastify, getMyProperties));
  fastify.get("/:id", getPropertyOpts(fastify, getProperty));
  ...
  fastify.post(
    "/upload/images/:id",
    uploadImagesOpts(fastify, addImagesProperty),
  );
  fastify.delete(
    "/upload/images/:id",
    deleteImagesOpts(fastify, deleteImagesProperty),
  );
  done();
};
