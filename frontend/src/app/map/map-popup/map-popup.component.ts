...
import { PropertyMap, PropertyMapPopup } from 'src/app/shared/interface/property';
...
export class MapPopupComponent {
  ...
  public async onPopupOpen() {
    ...
    try {
      const res = await firstValueFrom(this.propertiesService.fetchProperty(this.property?.property_id, params));
      ...
      console.log("MapPopupComponent onPopupOpen finally, isLoading:", this.propertyDetails());
